...
import { ToolComponentRenderer } from "@/components/fix-os/tool-component-renderer";
          ...
          >
            ...
            >
              ...
              >
                ...
                />
                <ToolcallInfo />
                {/* Render Fix-OS tool-associated components */}
                <ToolComponentRenderer className="w-full" />
